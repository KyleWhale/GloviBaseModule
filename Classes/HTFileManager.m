...
+ (NSString *)ht_filePathWithSearchPath:(NSSearchPathDirectory)searchPath andDirectoryPath:(NSString *)directoryPath andFileName:(NSString *)var_fileName {
    // 目录
    ...
    // 文件路径
    NSString * filePath = [NSString stringWithFormat:@"%@/%@",dirPath,var_fileName];
    if ( [var_fileName hasPrefix:@"/"] ) {
        filePath = [NSString stringWithFormat:@"%@%@",dirPath,var_fileName];
    }
...
+ (NSURL *)ht_fileURLWithSearchPath:(NSSearchPathDirectory)searchPath andDirectoryPath:(NSString *)directoryPath andFileName:(NSString *)var_fileName {
    NSString *filePath = [self ht_filePathWithSearchPath:searchPath andDirectoryPath:directoryPath andFileName:var_fileName];
